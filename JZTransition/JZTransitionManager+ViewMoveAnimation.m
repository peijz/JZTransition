//
//  JZTransitionManager+ViewMoveAnimation.m
//  JZTransition
//
...
@implementation JZTransitionManager (ViewMoveAnimation)


- (void)viewMoveRollNextWithType:(JZTransitionAnimationType )type andContext:(id<UIViewControllerContextTransitioning>)transitionContext {
...
- (void)viewMoveNextWithType:(JZTransitionAnimationType )type andContext:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    if (type == JZTransitionAnimationTypeViewMoveToNextVC) {
