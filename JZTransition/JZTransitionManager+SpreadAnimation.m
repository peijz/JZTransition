//
//  JZTransitionManager+SpreadAnimation.m
//  JZTransition
//
...
@implementation JZTransitionManager (SpreadAnimation)
...
- (void)spreadNextWithType:(JZTransitionAnimationType)type andTransitonContext:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    switch (type) {
        case JZTransitionAnimationTypeSpreadFromRight:
            rect0 = CGRectMake(screenWidth, 0, 2, screenHeight);
            break;
        case JZTransitionAnimationTypeSpreadFromLeft:
            rect0 = CGRectMake(0, 0, 2, screenHeight);
            break;
        case JZTransitionAnimationTypeSpreadFromTop:
